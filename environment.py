...
class StockEnvironment(Environment): # 주식 환경
    def __init__(self, stock_code_list = ["005930","000660", "083650", "010120", "035720", "012450", "098460", "064350", "056080", "068270", "039030"], 
    ...
    def reset(self) -> Tuple[Any, dict]: # ndarray, {None}
        ...
        result = self.stock.load_datas("API\datas\ " + self.stock_code + ".csv", inqr_strt_dt=self.strt_dt, count=self.count)
        #print(result)
